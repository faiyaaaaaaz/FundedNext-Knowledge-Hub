...
3. Import the repo into Vercel and add the 4 variables above. Deploy.
4. Open the app → sign in with `APP_PASSWORD` → go to **Admin** → paste your Intercom + OpenAI keys → Save.
