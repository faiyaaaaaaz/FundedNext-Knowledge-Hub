...
function signSession({ role, version, sessionId, name, email, authProvider, userId }) {
...
export async function createGoogleLoginSession(accessToken) {
  ...
  const token = signSession({
    role, version, sessionId, name, email: normalizedEmail, authProvider: 'google', userId: user.id
  });
  return {
