        ...
        {tab === 'querylogs' && <div className="settings-stack query-log-page">
          ...
          <section className="settings-card">
            ...
            <div className="query-log-list">{(queryLogs?.logs || []).map((log) => {
              ...
              return <article className={`query-log-card${expanded ? ' expanded' : ''}${selected ? ' selected' : ''}${log.feedback ? ` has-feedback ${log.feedback}` : ''}`} key={log.id}>
